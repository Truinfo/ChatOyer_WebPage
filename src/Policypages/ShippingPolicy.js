  ...
  return (
    <div className="disclaimer_header">
      ...
      <div className="Shipping-content">
        ...
        <h2 style={{fontFamily:"'Domine', serif", fontSize:"25px", marginTop:"20px"}}>Shipping Fees</h2>
        <p>
        ...
        <p>
          ...
          customer support team at support@chatoyer.com. We will work
        ...
        <p>
          ...
          support@chatoyer.com.
        </p>
        <p>
          By placing an order with Chatoyer, Chatoyer agree to comply
