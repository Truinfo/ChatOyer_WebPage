  ...
  return (
    <div className="disclaimer_header">
      ...
      <div className="paracontent">
        ...
        <p className="paracontent"><b style={{fontFamily:"'Domine', serif"}}>CONTACT NUMBER:</b> 18001236547</p>
        <p className="paracontent"><b style={{fontFamily:"'Domine', serif"}}>EMAIL:</b> support@chatoyer.com</p>
      </div>
    </div>
  );
};
